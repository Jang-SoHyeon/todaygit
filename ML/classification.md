...
정밀도(precision)가 높다는 것은 분류기가 주어진 샘플(instance)을 positive라고 예측하면 그 예측이 맞을 확률이 높다는 의미  

<hr> 

앞서 살펴본 SGD classifier의 정밀도 : 3530 / 3530 + 687 = 0.83708  
array([[53892,  687],  
       &emsp;[1891,  3530]])  
...
- 재현율  
<img src = "../image/재현율.png" width=60%>
